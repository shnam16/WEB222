...
window.onload=function(){
    var tableContainer=document.querySelector("#table3");
    var myTable = "<tr>" + "<th>First Name</th>" + "<th>Last name</th>" + "<th>Age</th>" + "<th>Email</th>" + "</tr>";
    
    for(var i = 0; i < users.length; i++){
        myTable += "<tr>" + "<td>" + users[i].first_name + "</td>" + "<td>" + users[i].last_name + "</td>" + "<td>" + users[i].age + "</td>" + "<td>" + "<a href= 'mailto:" + users[i].email + "'>" + users[i].email + "</a>" + "</td>" + "</tr>";

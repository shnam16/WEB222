...
window.onload = function(){
    var myContainer = document.querySelector("#nature");
    var myImage = "<figure>";
    
    for(var i = 0; i < images.length; i++){
        myImage += "<img alt='" + images[i].alt + "'" + " src='" + images[i].url + "' />" + "<figcaption>" + images[i].caption + "</figcaption>" + "<br />";
        }
    myImage += "</figure>";
    myContainer.innerHTML += myImage;
    };
